...
This is the recommended option. In this way we're performing an "on-top" import of the backup as described in [](ModelMaintenanceConcepts.md#assign-based-on-top-updates):
