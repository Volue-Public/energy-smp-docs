# Public Mesh REST API for Volue Mesh v.2.19
...
- [Public Mesh REST API for Volue Mesh v.2.19](#public-mesh-rest-api-for-volue-mesh-v219)
  - [Version **v1** Endpoints](#version-v1-endpoints)
    - [`GET /api/v1/GetVersion`](#get-apiv1getversion)
    - [`GET /api/v1/GetUserIdentity`](#get-apiv1getuseridentity)
    - [`GET /api/v1/CreateSession`](#get-apiv1createsession)
    - [`POST /api/v1/Commit`](#post-apiv1commit)
    - [`POST /api/v1/Rollback`](#post-apiv1rollback)
    - [`GET /api/v1/CloseSession`](#get-apiv1closesession)
    - [`GET /api/v1/ExtendSession`](#get-apiv1extendsession)
    - [`GET /api/v1/ReadTimeSeriesValuesRaw`](#get-apiv1readtimeseriesvaluesraw)
    - [`GET /api/v1/ReadTimeSeriesValues`](#get-apiv1readtimeseriesvalues)
    - [`POST /api/v1/ReadTimeSeriesValuesMultiRaw`](#post-apiv1readtimeseriesvaluesmultiraw)
    - [`POST /api/v1/ReadTimeSeriesValuesMulti`](#post-apiv1readtimeseriesvaluesmulti)
    - [`POST /api/v1/WriteTimeSeriesValuesMultiRaw`](#post-apiv1writetimeseriesvaluesmultiraw)
    - [`POST /api/v1/CreatePhysicalTimeSeries`](#post-apiv1createphysicaltimeseries)
    - [`GET /api/v1/ListModels`](#get-apiv1listmodels)
    - [`GET /api/v1/SearchForObjects`](#get-apiv1searchforobjects)
    - [`GET /api/v1/GetObject`](#get-apiv1getobject)
    - [`POST /api/v1/CreateObject`](#post-apiv1createobject)
    - [`POST /api/v1/UpdateObject`](#post-apiv1updateobject)
    - [`POST /api/v1/DeleteObject`](#post-apiv1deleteobject)
    - [`GET /api/v1/SearchForAttributes`](#get-apiv1searchforattributes)
    - [`GET /api/v1/GetAttribute`](#get-apiv1getattribute)
    - [`GET /api/v1/GetTimeseriesResource`](#get-apiv1gettimeseriesresource)
    - [`GET /api/v1/GetRatingCurveVersions`](#get-apiv1getratingcurveversions)
    - [`GET /api/v1/GetXySets`](#get-apiv1getxysets)
    - [`POST /api/v1/UpdateIntAttribute`](#post-apiv1updateintattribute)
    - [`POST /api/v1/UpdateDoubleAttribute`](#post-apiv1updatedoubleattribute)
    - [`POST /api/v1/UpdateBoolAttribute`](#post-apiv1updateboolattribute)
    - [`POST /api/v1/UpdateStringAttribute`](#post-apiv1updatestringattribute)
    - [`POST /api/v1/UpdateDateTimeAttribute`](#post-apiv1updatedatetimeattribute)
    - [`POST /api/v1/UpdateTimeSeriesAttribute`](#post-apiv1updatetimeseriesattribute)
    - [`POST /api/v1/UpdateLinkRelationAttribute`](#post-apiv1updatelinkrelationattribute)
    - [`POST /api/v1/UpdateRatingCurveVersions`](#post-apiv1updateratingcurveversions)
    - [`POST /api/v1/UpdateXySets`](#post-apiv1updatexysets)
    - [`POST /api/v1/ImportMultistepWaterValueFunctions`](#post-apiv1importmultistepwatervaluefunctions)
    - [`POST /api/v1/IdentifyVirtualTSusage`](#post-apiv1identifyvirtualtsusage)
  - [Version **v1** Schemas](#version-v1-schemas)
    - [MeshAccumulationEnum](#meshaccumulationenum)
    - [MeshAttribute](#meshattribute)
    - [MeshAttributeSimple](#meshattributesimple)
    - [MeshAttributeValue](#meshattributevalue)
    - [MeshAttributeValueEnum](#meshattributevalueenum)
    - [MeshCurveTypeEnum](#meshcurvetypeenum)
    - [MeshInterval](#meshinterval)
    - [MeshLinkRelation](#meshlinkrelation)
    - [MeshLinkRelationVersion](#meshlinkrelationversion)
    - [MeshObject](#meshobject)
    - [MeshObjectSimple](#meshobjectsimple)
    - [MeshOwnershipRelation](#meshownershiprelation)
    - [MeshRatingCurveSegment](#meshratingcurvesegment)
    - [MeshRatingCurveVersion](#meshratingcurveversion)
    - [MeshReferencedObject](#meshreferencedobject)
    - [MeshResolutionEnum](#meshresolutionenum)
    - [MeshTimeZoneAlignmentEnum](#meshtimezonealignmentenum)
    - [MeshTimeseries](#meshtimeseries)
    - [MeshTimeseriesResource](#meshtimeseriesresource)
    - [MeshTimeseriesValues](#meshtimeseriesvalues)
    - [MeshTsId](#meshtsid)
    - [MeshUserIdentityInfo](#meshuseridentityinfo)
    - [MeshValue](#meshvalue)
    - [MeshVersionInfo](#meshversioninfo)
    - [MeshVersionedLinkRelation](#meshversionedlinkrelation)
    - [MeshXyCurve](#meshxycurve)
    - [MeshXySet](#meshxyset)
    - [MultiStepWaterValues](#multistepwatervalues)
    - [VirtualTSinfo](#virtualtsinfo)
